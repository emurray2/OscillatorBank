//
//  Oscillator_Bank_AUAudioUnit.m
//  Oscillator Bank AU
//
//  Created by Aura Audio on 6/6/22.
//

#import "Oscillator_Bank_AUAudioUnit.h"
...
@interface Oscillator_Bank_AUAudioUnit ()
...
@implementation Oscillator_Bank_AUAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[Oscillator_Bank_AUDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block Oscillator_Bank_AUDSPKernelAdapter * kernelAdapter = _kernelAdapter;
